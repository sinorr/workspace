...
public class LDACmdOption {
	...
	public String wordMapFileName = "wordmap";
	
	@Option(name="-nlans", usage="Specify the sum of languages")
	public int L = 1;
	
	@Option(name="-langs", usage="Specify the names suffix of languages, separated by '&' like en&ch ")
	public String langNames = "en";
}
